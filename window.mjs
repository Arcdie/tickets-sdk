...
export default class Window {
  constructor(jsdomConfig = {}) {
    ...
    arr.forEach(e => {
      cookieJar.setCookieSync(e, '.livenation.com');
    });
    */

    const url = 'https://concerts.livenation.com/event/00005E66AD4B2014';

    const jsdom = (new JSDOM('', Object.assign(jsdomConfig, {
      resources,
      // cookieJar,
      url,
    })));
    ...
    */
    ...
    Object.defineProperty(window.location, 'href', {
      writable: true,
      value: 'https://concerts.livenation.com/event/00005E66AD4B2014',
    });
    */
